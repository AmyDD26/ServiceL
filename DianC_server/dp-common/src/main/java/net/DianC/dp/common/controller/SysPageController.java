package net.DianC.dp.common.controller;
...
public class SysPageController {
	 ...
	 * @return
	 */
	@RequestMapping("{module}/{function}/{function2}/{url}.html")
	public String page(@PathVariable("module") String module, @PathVariable("function") String function, 
			@PathVariable("function2") String function2,
			@PathVariable("url") String url) {
		return module + "/" + function + "/" + function2 + "/" + url + ".html";
	}
