package net.DianC.dp.quartz.service.impl;
...
import net.DianC.dp.common.constant.SystemConstant.ScheduleStatus;
...
import net.DianC.dp.quartz.manager.QuartzJobManager;
import net.DianC.dp.quartz.service.QuartzJobService;
import net.DianC.dp.quartz.utils.ScheduleUtils;
...
public class QuartzJobServiceImpl implements QuartzJobService {
	...
	public Page<QuartzJobEntity> list(Map<String, Object> params) {
		...
		Page<QuartzJobEntity> page = new Page<QuartzJobEntity>(query);
